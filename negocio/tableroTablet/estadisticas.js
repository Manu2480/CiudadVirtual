...
function ejecutar(){
    ...
    const panelEstadisticasVertical = document.getElementById("panel-estadisticas-tablet-horizontal");
    const panelEstadisticasHorizontal = document.getElementById("panel-estadisticas-tablet-vertical");
    renderizarPanel(ciudad, panelEstadisticasVertical);
    renderizarPanel(ciudad, panelEstadisticasHorizontal);

}
function renderizarPanel(ciudad,panel){
    if (!panel) return;
