    ...
    const html = `
        <div class="modal-edificio">
            ...
            <ul class="modal-edificio__stats">
                ...
                ${edificio.mantenimiento ? `<li><i class="fi fi-br-coins"></i> Mantenimiento: <strong style="color:var(--color-energia)">-$${edificio.mantenimiento.toLocaleString()}/turno</strong></li>` : ""}
                ${ocupacionHtml}
                ${felicidadPromedioHtml}
